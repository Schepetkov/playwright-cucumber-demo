#always fail, because BUG, subjects field is not working
Feature: TC03
    @positive
    Scenario: Verify user can submit the from
        ...
        Then Enter data in practice form
            ...
            | Test       | BV        | test@test.com | Male   | 0123456789 | 15            | January        | 1990          | Computer Science | Reading | Netherlangs     | NCR   | Delhi |
